...
/**
 * Service for Entry file operations
 */
@Service
public class EntryFileService {

    private final Logger logger = LoggerFactory.getLogger(EntryFileService.class);

    /**
     * To parse and validate entry file
     *
     * @param file Entry File
     * @param validationEnabled Flag to enable validation
     * @return List<Outcome>
     */
